...
const SouthAmericaPage = () => {
  ...
  const southAmericaCountries = continents.southAmerica.countries;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-gray-900">South America</span>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">South American Countries</h1>
          <p className="text-xl text-gray-600 mb-6">
            Explore financial tools and government budget resources for South American countries.
          </p>
        </div>
