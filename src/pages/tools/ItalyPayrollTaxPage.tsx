...
import ItalyPayrollTaxCalculator from "@/components/tools/ItalyPayrollTaxCalculator";
import { Button } from "@/components/ui/button";
import { ArrowLeft } from "lucide-react";
import { LanguageCode, languages } from "@/data/languages";

const ItalyPayrollTaxPage = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Italy Payroll Tax Calculator</h1>
          <p className="text-xl text-gray-600 mb-6">
            Calculate Italian payroll taxes including social security contributions for employees and employers.
          </p>
...
export default ItalyPayrollTaxPage;
