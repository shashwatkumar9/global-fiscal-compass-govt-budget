...
import ItalyInheritanceTaxCalculator from "@/components/tools/ItalyInheritanceTaxCalculator";
import { Button } from "@/components/ui/button";
import { ArrowLeft } from "lucide-react";
import { LanguageCode, languages } from "@/data/languages";

const ItalyInheritanceTaxPage = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Italy Inheritance Tax Calculator</h1>
          <p className="text-xl text-gray-600 mb-6">
            Calculate Italian inheritance and gift taxes with relationship-based rates and exemption thresholds.
          </p>
...
export default ItalyInheritanceTaxPage;
