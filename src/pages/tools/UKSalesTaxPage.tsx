...
import UKSalesTaxCalculator from "@/components/tools/UKSalesTaxCalculator";
import { Button } from "@/components/ui/button";
import { ArrowLeft } from "lucide-react";
import { Link } from "react-router-dom";
import { LanguageCode, languages } from "@/data/languages";

const UKSalesTaxPage = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <Link to={`/tool/${lang}/united-kingdom/sales-tax-calculator`} className="hover:text-blue-600">United Kingdom</Link>
          <span>/</span>
