...
import { baseTools, germanTools, ukTools, franceTools, italyTools, spainTools } from "@/data/tools";
...
const MegaMenu = ({ 
  ...
  const getCountryTools = (country: string | null) => {
    ...
    if (country === 'Italy') {
      return {
        popular: italyTools.slice(0, 10),
        advanced: italyTools.slice(10)
      };
    }

    if (country === 'Spain') {
      return {
        popular: spainTools.slice(0, 10),
        advanced: spainTools.slice(10)
      };
    }
